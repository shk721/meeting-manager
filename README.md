...
- **لوحة التحكم** — إحصائيات شاملة + رسوم بيانية زمنية (يومي/أسبوعي/شهري)
- **الملف الشخصي** — تعديل البيانات، السمة، اللغة، ومصادقة ثنائية
- **الإشعارات** — إشعارات فورية عند إنشاء الاجتماعات
- **البحث والفلترة** — بحث ILIKE + عروض مرشّحة محفوظة
- **اللجان** — إدارة اللجان الداخلية والخارجية وجلساتها وقراراتها
- **بوابة شخصية** — ملخص كل ما يخص المستخدم بدون login
- **مركز التحول الرقمي** — متابعة مبادرات وخطط التحول
...
| [DEPLOYMENT.md](./DEPLOYMENT.md) | النشر على Railway |
| [API.md](./API.md) | مرجع الـ API |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | دليل المساهمة |

**Swagger UI**: `http://localhost:5000/api-docs` (بعد تشغيل الخادم)
