...
const C = {
  ...
  accentDark: "#155c39", error: "#c0492f", errorBg: "#fbeeea",
};
...
export default function Login() {
  ...
  useEffect(() => {
    if (user) window.location.href = "/dt/";
  }, [user]);
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: 32, textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: C.text, margin: 0 }}>التمكين الرقمي (المبادرات)</h1>
      ...
      <p style={{ marginTop: 20, fontSize: 12, color: C.muted, textAlign: "center" }}>
        ليس لديك حساب؟ تواصل مع مسؤول النظام
      </p>
    </div>
  );
}
